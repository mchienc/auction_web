                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <div class="p-6">
                            ...
                            @elseif($auction->status == 'running')
                                <span class="mt-2 inline-block bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded">Đang diễn ra</span>
                            @endif

                            <div class="mt-4">
                                <a href="{{ route('auctions.show', $auction) }}" class="w-full text-center inline-flex items-center justify-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
                                    Xem chi tiết
                                </a>
                            </div>
                        </div>
